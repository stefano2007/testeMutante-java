...
public class CalculadoraService4Test {
/*
    ...
    @Test
    public void testCalcularMedia5Recuperacao() {
    ...
    @Test
    public void testCalcularMedia6Recuperacao() {
    ...
    public void testCalcularMediaReprovado() {
        CalcularMediaDTO request = new CalcularMediaDTO(4.99, 4.99);
        String resultado = calculadoraService.calcularMedia(request);
